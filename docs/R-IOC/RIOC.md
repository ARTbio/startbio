...
* Sun Jun 18 2023 08:29:42 GMT-0700 (PDT)
* Source doc: R-intro-md
...
A variable is a named (“x”, “mydata”) placeholder to store data (12, “my boss”). Variablesat the core of any programming language. Instead of directly manipulating the data, you manipulate variables, which you can think of as abstractions of the data. It should be noted that sometimes, R programmers use the term “object” in place of “variable”. No worries, we are still talking about variables!

A variable has a type (Integer, character, etc) and may have different structures (scalar, vector, dataframe, etc.)

For an introduction to variables in R, read the section [1.10 - Variables](https://bookdown.org/ansellbr/WEHI_tidyR_course_book/welcome-to-r.html#variables) and [1.11 - Vectors](https://bookdown.org/ansellbr/WEHI_tidyR_course_book/welcome-to-r.html#vectors) from Brendan R. E.
