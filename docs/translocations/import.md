...
??? tip "Step-1: Transfer datasets from the Data library to a new history"
...
??? tip "Step-2: Create data collections in you `Input Datasets and Collections` history"
...
??? tip "Step-3: Send dataset collections in a new history"
